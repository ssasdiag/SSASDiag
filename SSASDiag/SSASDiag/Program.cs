            ...
            if (AppDomain.CurrentDomain.BaseDirectory != m_strPrivateTempBinPath)
            {
                ...
                try {
                    if (!File.Exists(m_strPrivateTempBinPath + "SSASDiag.exe") || 
                            (File.Exists(m_strPrivateTempBinPath + "SSASDiag.exe") && new FileInfo(m_strPrivateTempBinPath + "SSASDiag.exe").CreationTimeUtc != new FileInfo(Application.ExecutablePath).CreationTimeUtc))
